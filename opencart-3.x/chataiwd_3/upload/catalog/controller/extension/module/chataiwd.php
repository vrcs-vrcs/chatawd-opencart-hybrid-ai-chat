...
class ControllerExtensionModuleChataiwd extends Controller {
    ...
    public function index(): string {
        ...
        $data['css_url'] = HTTP_SERVER . 'catalog/view/javascript/chataiwd_styles.css';
        $data['css_product_url'] = HTTP_SERVER . 'catalog/view/javascript/chataiwd_product.css';
        $data['js_url'] = HTTP_SERVER . 'catalog/view/javascript/chataiwd_script.js';
        $data['js_product_url'] = HTTP_SERVER . 'catalog/view/javascript/chataiwd_product.js';
            ...
            if (!$current_id) {
                ...
                if ($path) {
                    ...
                    if ($keyword && $keyword != 'index.php') {
                        ...
                        $seo_info = $this->{$this->model_function}->getSeoUrlByKeyword($keyword);

                        if ($seo_info) {
                            if (isset($seo_info['key']) && $seo_info['key'] == 'product_id') {
                                $current_id = (int)$seo_info['value'];

                            } elseif (isset($seo_info['query'])) {
                                if (strpos($seo_info['query'], 'product_id=') === 0) {
                                    $current_id = (int)substr($seo_info['query'], 11);
                                }
                            }
                        }
                    }
